Pod::Spec.new do |spec|
  ...
  spec.subspec 'Live' do |live|
    ...
    live.source_files = 'Source/Localized/**/*.{h,m,mm}', 'Source/Model/**/*.{h,m,mm,c}', 'Source/Server/**/*.{h,m,mm}', 'Source/UI/**/*.{h,m,mm}', 'Source/PublicHeader/**/*.{h,m,mm}',  'Source/Common/**/*.{h,m,mm}', 'Source/Presenter/**/*.{h,m,mm}', 'Source/TUIPusherKit_Live/*.{h,m,mm}'
    live.ios.framework = ['AVFoundation', 'Accelerate', 'AssetsLibrary']
    live.library = 'c++', 'resolv', 'sqlite3'
    live.resource_bundles = {
      'TUIPusherKitBundle' => ['Resources/Localized/**/*.strings', 'Resources/*.xcassets']
    }
  end
  ...
  spec.subspec 'Professional' do |professional|
    ...
    professional.source_files = 'Source/Localized/**/*.{h,m,mm}', 'Source/Model/**/*.{h,m,mm,c}', 'Source/Server/**/*.{h,m,mm}', 'Source/UI/**/*.{h,m,mm}', 'Source/PublicHeader/**/*.{h,m,mm}', 'Source/Common/**/*.{h,m,mm}', 'Source/Presenter/**/*.{h,m,mm}', 'Source/TUIPusherKit_Professional/*.{h,m,mm}'
  ...
  spec.subspec 'Enterprise' do |enterprise|
    ...
    enterprise.source_files = 'Source/Localized/**/*.{h,m,mm}', 'Source/Model/**/*.{h,m,mm,c}', 'Source/Server/**/*.{h,m,mm}', 'Source/UI/**/*.{h,m,mm}', 'Source/PublicHeader/**/*.{h,m,mm}', 'Source/Common/**/*.{h,m,mm}', 'Source/Presenter/**/*.{h,m,mm}', 'Source/TUIPusherKit_Enterprise/*.{h,m,mm}'
