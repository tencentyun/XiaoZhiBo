...
/**
 * 美颜数据的解析类
 * 将美颜JSON数据解析为TUIBeautyInfo类型的数据
 */
public class TUIBeautyResourceParse {

    private static final String TAG                 = "TUIBeautyResourceParse";
    ...
    public static TUIBeautyInfo createBeautyInfo(String json) {
        Gson gson = new Gson();
        return gson.fromJson(json, TUIBeautyInfo.class);
    }
