...
public class IMRoomManager implements IIMRoomManager {
        ...
        V2TIMManager.getInstance().createGroup(V2TIMManager.GROUP_TYPE_AVCHATROOM, roomId,
                roomName, new V2TIMValueCallback<String>() {
                    ...
                    public void onError(int code, String s) {
                        String msg = s;
                        if (code == 10036) {
                            msg = mContext.getString(R.string.showlive_create_room_limit);
                        }
                        if (code == 10037) {
                            msg = mContext.getString(R.string.showlive_create_or_join_group_limit);
                        }
                        if (code == 10038) {
                            msg = mContext.getString(R.string.showlive_group_member_limit);
                        }
                        if (code == 10025) {
    ...
    public void setIMServiceListener(IMServiceListener listener) {
        this.mIMServiceListener = listener;
    }
    ...
    private class LiveRoomGroupListener extends V2TIMGroupListener {
        ...
        public void onGroupDismissed(String groupID, V2TIMGroupMemberInfo opUser) {
            ...
            if (mIMServiceListener != null) {
                mIMServiceListener.onGroupDismissed(groupID);
            }
        }
