...
public class FollowAnchorDialog extends BottomSheetDialog {
    ...
    public FollowAnchorDialog(Context context, boolean isFollow, String anchorName, String anchorAvatar) {
        ...
        ImageLoader.loadImage(getContext(), mImageAvatar, anchorAvatar, R.drawable.showlive_bg_cover);
        mTextName.setText(anchorName);
        if (isFollow) {
            mImageAdd.setVisibility(View.GONE);
            mLinearLayout.setBackgroundResource(R.drawable.showlive_bg_already_follow_anchor);
            mTextFollow.setText(mContext.getResources().getString(R.string.showlive_already_followed));
            mTextFollow.setTextColor(mContext.getResources().getColor(R.color.showlive_color_black));
        }
        mLinearLayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (mIsFollow) {
                    ...
                    mTextFollow.setText(mContext.getResources().getString(R.string.showlive_follow));
                    mLinearLayout.setBackgroundResource(R.drawable.showlive_bg_follow_anchor);
                    mImageAdd.setVisibility(View.VISIBLE);
                    mTextFollow.setTextColor(mContext.getResources().getColor(R.color.showlive_color_white));
                }
