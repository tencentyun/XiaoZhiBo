...
public class HourRankDialog extends BottomSheetDialog {
    ...
    public HourRankDialog(Context context, String roomId) {
        ...
        setContentView(R.layout.app_hour_rank_dialog);
                                ...
                                if (info.roomId.equals(mRoomId)) {
                                    if (ranking == 1) {
                                        mTextAnchorRanking.setTextColor(mContext.getResources()
                                                .getColor(R.color.app_ranking_text_first));
                                    } else if (ranking == 2) {
                                        mTextAnchorRanking.setTextColor(mContext.getResources()
                                                .getColor(R.color.app_ranking_text_second));
                                    } else if (ranking == 3) {
                                        mTextAnchorRanking.setTextColor(mContext.getResources()
                                                .getColor(R.color.app_ranking_text_third));
                                    }
                                    ...
                                    ImageLoader.loadImage(mContext, mImageAnchorAvatar,
                                            info.coverUrl, R.drawable.app_bg_cover);
                                    String totalJoined;
