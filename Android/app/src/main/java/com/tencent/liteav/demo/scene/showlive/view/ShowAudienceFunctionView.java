...
import com.tencent.liteav.demo.discover.WebViewActivity;
import com.tencent.liteav.demo.scene.showlive.dialog.FollowAnchorDialog;
import com.tencent.liteav.demo.scene.showlive.dialog.MoreLiveDialog;
import com.tencent.liteav.demo.scene.showlive.dialog.HourRankDialog;
import com.tencent.liteav.demo.scene.showlive.dialog.OnlineAudienceDialog;
...
public class ShowAudienceFunctionView extends FrameLayout implements View.OnClickListener {
    ...
    private void updateAudienceListInfo(List<AudienceInfo> list) {
        ...
        if (list.size() >= 4) {
            ...
            ImageLoader.loadImage(getContext(), mImageAudience1, list.get(0).getAvatar(), R.drawable.app_bg_cover);
            ImageLoader.loadImage(getContext(), mImageAudience2, list.get(1).getAvatar(), R.drawable.app_bg_cover);
            ImageLoader.loadImage(getContext(), mImageAudience3, list.get(2).getAvatar(), R.drawable.app_bg_cover);
            ImageLoader.loadImage(getContext(), mImageAudience4, list.get(3).getAvatar(), R.drawable.app_bg_cover);
        } else if (list.size() == 3) {
            mImageAudience1.setVisibility(VISIBLE);
            mImageAudience2.setVisibility(VISIBLE);
            mImageAudience3.setVisibility(VISIBLE);
                            ...
                            new Handler(Looper.getMainLooper()).post(new Runnable() {
                                ...
                                public void run() {
                                    ...
                                    ToastUtils.showShort(getContext().getResources()
                                            .getString(R.string.app_follow_success));
                                }
                            });
                            mIsFollowed = true;
                        }
                ...
                if (code == 0) {
                    new Handler(Looper.getMainLooper()).post(new Runnable() {
                        ...
                        public void run() {
                            ...
                            ToastUtils.showShort(getContext().getResources().getString(R.string.app_unfollow_success));
                        }
                    });
                    mIsFollowed = false;
                }
